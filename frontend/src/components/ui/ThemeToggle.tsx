...
export const ThemeToggleButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "cursor-pointer flex items-center justify-center rounded-lg border border-[#27272A] bg-[#09090B] p-2 hover:bg-[#18181B] transition-colors",
        className,
      )}
      onClick={toggleTheme}
    ...
    >
      {isDark ? (
        // Moon Icon
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#ea580c]">
          <path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/>
        </svg>
      ) : (
        // Sun Icon
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 text-[#F59E0B]">
